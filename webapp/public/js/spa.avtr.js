...
spa.avtr = (function(){
	...
	// Begin public method /configModel/
	// Example: spa.avtr.configModule({...})
	// Purpose: configure the module prior to initialization,
	//          values we do not expect to change during a user sesssion.
	// Action:
	//   The internal configuration data structure(configMap)
	//   is updated with provided arguments. No other action are taken.
	// Returns: none
	...
	// End public method /configModel/
	// Begin public method /initModule/
	// Example: spa.avtr.initModule($container);
	// Purpose: Directs the mocule to begin offering its feature
	// Arguments: $container - container to use
	// Action: Provides  avtar interface for chat users
	// Returns: none
	// Throws: none
	//
